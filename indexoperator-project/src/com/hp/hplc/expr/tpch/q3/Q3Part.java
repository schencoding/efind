 ...
 * @date 2012-5-31
 */
public class Q3Part extends Configured implements Tool{
	...
	public static void main(String[] args) {
		try {
			int exitCode = ToolRunner.run(new Q3Part(), args);
	...
	public int run(String[] args) throws Exception {
		...
		conf.setJarByClass(Q3Part.class);
		...
		orders.addCoPartitionedWithIndex(0);
